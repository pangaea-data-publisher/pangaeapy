...
class PanDataSet:
    ...
    def _setEvents(self, panXMLEvents):
        ...
        for event in panXMLEvents:
            ...
            self.events.append(PanEvent(eventLabel, eventLatitude, eventLongitude, eventLatitude2, eventLongitude2, eventElevation, eventDateTime, eventDateTime2, eventDevice, eventBasis, eventLocation, eventCampaign, eventID, eventDeviceID))
